...
public class IFCtoIPFS_TestABEPublish2woIPFS extends IFCtoIPFS_TestABEPublishCommonWoIPFS {
	
	public IFCtoIPFS_TestABEPublish2woIPFS(String project_name, int attribute_count, String gp_hash) {
	...
	public static void main(String[] args) {
		...
		for (int attribute_count = start; attribute_count >= 0; attribute_count--)
			try {
				if (args.length > 1) {
					IFCtoIPFS_TestABEPublish2woIPFS ifc_ipfs = new IFCtoIPFS_TestABEPublish2woIPFS("2woi",
