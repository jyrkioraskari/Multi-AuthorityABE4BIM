...
public class IPFS_ABEFetchIFCIPFSSplit_DirectoryEntries extends IPFS_Logging{
	...
	public IPFS_ABEFetchIFCIPFSSplit_DirectoryEntries(String directory,int attribute_count,String gp_hash) {
	...
	public static void main(String[] args) {
		if(args.length==2)
		{
			...
			for (int attribute_count = start; attribute_count >= 0; attribute_count--)
		      new IPFS_ABEFetchIFCIPFSSplit_DirectoryEntries(args[0],attribute_count,args[1]);
		}
		else
